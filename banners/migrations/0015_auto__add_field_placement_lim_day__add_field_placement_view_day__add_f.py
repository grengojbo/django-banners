...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Placement.lim_day'
        db.add_column(u'banners_placement', 'lim_day',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Placement.view_day'
        db.add_column(u'banners_placement', 'view_day',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Placement.lim_unique'
        db.add_column(u'banners_placement', 'lim_unique',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Placement.lim_day'
        db.delete_column(u'banners_placement', 'lim_day')

        # Deleting field 'Placement.view_day'
        db.delete_column(u'banners_placement', 'view_day')

        # Deleting field 'Placement.lim_unique'
        db.delete_column(u'banners_placement', 'lim_unique')
    ...
    models = {
        ...
        u'banners.placement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lim_day': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            ...
            'lim_unique': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            ...
            'var': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'view_day': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
