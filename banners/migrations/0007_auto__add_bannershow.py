...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BannerShow'
        db.create_table(u'banners_bannershow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='show', to=orm['banners.Banner'])),
            ('zone', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banner_show', null=True, to=orm['banners.Zone'])),
            ('user_mac', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banner_show', null=True, to=orm['banners.Placement'])),
        ...
        db.send_create_signal(u'banners', ['BannerShow'])


    def backwards(self, orm):
        # Deleting model 'BannerShow'
        db.delete_table(u'banners_bannershow')
