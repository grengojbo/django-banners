...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'banners_zone', 'author_id')

        # Adding field 'Zone.resurces'
        db.add_column(u'banners_zone', 'resurces',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['banners.Resurce'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resurce.is_active'
        db.add_column(u'banners_resurce', 'is_active',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'banners_zone', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Zone.resurces'
        db.delete_column(u'banners_zone', 'resurces_id')

        # Deleting field 'Resurce.is_active'
        db.delete_column(u'banners_resurce', 'is_active')
