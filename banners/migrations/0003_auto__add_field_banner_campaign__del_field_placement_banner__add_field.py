...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.campaign'
        db.add_column(u'banners_banner', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['banners.Placement'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Placement.banner'
        db.delete_column(u'banners_placement', 'banner_id')

        # Adding field 'Placement.author'
        db.add_column(u'banners_placement', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Zone', fields ['english_name']
        db.create_unique(u'banners_zone', ['english_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Zone', fields ['english_name']
        db.delete_unique(u'banners_zone', ['english_name'])

        # Deleting field 'Banner.campaign'
        db.delete_column(u'banners_banner', 'campaign_id')


        # User chose to not deal with backwards NULL issues for 'Placement.banner'
        raise RuntimeError("Cannot reverse this migration. 'Placement.banner' and its values cannot be restored.")
        # Deleting field 'Placement.author'
        db.delete_column(u'banners_placement', 'author_id')
