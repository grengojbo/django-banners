...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Banner', fields ['name']
        db.create_unique(u'banners_banner', ['name'])

        # Adding field 'BannerShow.ses'
        db.add_column(u'banners_bannershow', 'ses',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Placement.unique_mac'
        db.add_column(u'banners_placement', 'unique_mac',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Placement.unique_session'
        db.add_column(u'banners_placement', 'unique_session',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'BannerClick.user'
        db.delete_column(u'banners_bannerclick', 'user_id')

        # Adding field 'BannerClick.ses'
        db.add_column(u'banners_bannerclick', 'ses',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Banner', fields ['name']
        db.delete_unique(u'banners_banner', ['name'])

        # Deleting field 'BannerShow.ses'
        db.delete_column(u'banners_bannershow', 'ses')

        # Deleting field 'Placement.unique_mac'
        db.delete_column(u'banners_placement', 'unique_mac')

        # Deleting field 'Placement.unique_session'
        db.delete_column(u'banners_placement', 'unique_session')

        # Adding field 'BannerClick.user'
        db.add_column(u'banners_bannerclick', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='banner_clicks', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'BannerClick.ses'
        db.delete_column(u'banners_bannerclick', 'ses')
