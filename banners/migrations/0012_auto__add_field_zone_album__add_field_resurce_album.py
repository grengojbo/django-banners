...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Zone.album'
        db.add_column(u'banners_zone', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imagestore.Album'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resurce.album'
        db.add_column(u'banners_resurce', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imagestore.Album'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Zone.album'
        db.delete_column(u'banners_zone', 'album_id')

        # Deleting field 'Resurce.album'
        db.delete_column(u'banners_resurce', 'album_id')
