...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BannerClick'
        db.create_table(u'banners_bannerclick', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clicks', to=orm['banners.Banner'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banner_clicks', null=True, to=orm['auth.User'])),
            ('user_mac', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banner_clicks', null=True, to=orm['banners.Placement'])),
        ...
        db.send_create_signal(u'banners', ['BannerClick'])

        # Adding field 'Banner.url_target'
        db.add_column(u'banners_banner', 'url_target',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Placement.created_at'
        db.add_column(u'banners_placement', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BannerClick'
        db.delete_table(u'banners_bannerclick')

        # Deleting field 'Banner.url_target'
        db.delete_column(u'banners_banner', 'url_target')

        # Deleting field 'Placement.created_at'
        db.delete_column(u'banners_placement', 'created_at')
