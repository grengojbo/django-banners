...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BannerShow.audits'
        db.add_column(u'banners_bannershow', 'audits',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'BannerClick.audits'
        db.add_column(u'banners_bannerclick', 'audits',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BannerShow.audits'
        db.delete_column(u'banners_bannershow', 'audits')

        # Deleting field 'BannerClick.audits'
        db.delete_column(u'banners_bannerclick', 'audits')
